...
```
There seems to be a negative linear relatinoshios between number of absences and final grade. It is slight, though. To further investigate this possible relationship, we compute a 99% CI for slope parameter $\beta_1$.
